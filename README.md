...
const KanaResVector res1 = Kana::kanaToRomaji(raw1, Kana::Error::Default, true);
std::cout << "test1: Kana->romaji (Default)" << std::endl << raw1 << " -> " << res1.toStdStr() << std::endl;

const RomajiResVector res2 = Kana::romajiToKana(res1, Kana::Error::Default, Kana::KanaType::Hiragana);
...
*/
KanaResVector kanaToRomaji(const std::string &kanaStr, Error error = Error::Default, const bool &doubleWrittenSokuon = false);
